عالی! من یک نسخه‌ی **کاملاً GitHub Markdown-ready** از README شما آماده کردم که می‌توانی مستقیم در GitHub کپی و استفاده کنی. تمام بخش‌ها با فرمت مناسب، کدهای رنگی و جداول برای API و پورت‌ها آماده شده است:
